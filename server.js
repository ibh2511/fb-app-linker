...
app.get("/", (req, res) => {
  ...
  res.send(`
      ...
      <body>
          ...
          <p>This service allows users to open Facebook links in the Facebook app by providing the FB link as a query parameter or referencing a 
             pre-configured environment variable.</p> 
          <p>It ensures seamless redirection and simplifies access to specific Facebook pages or content</p>
